  ...
  if (userRole !== 'ADMIN') {
    return (
      <div className="h-[80vh] flex items-center justify-center md:perspective-[1000px]">
        <div className="card-3d bg-slate-100 dark:bg-black/40 border border-red-500/30 rounded-3xl p-12 text-center max-w-lg relative overflow-hidden">
          ...
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white font-[Space_Grotesk] tracking-widest">ACCESS DENIED</h2>
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div className="relative">
           ...
           <h2 className="relative z-10 text-3xl md:text-4xl font-bold text-slate-900 dark:text-white tracking-tight font-[Space_Grotesk] flex items-center gap-3 text-glow">
            <Sparkles className="w-8 h-8 text-purple-400 animate-spin-slow" />
            eSTORE <span className="text-purple-500">Intelligence</span>
          </h2>
          <p className="relative z-10 text-slate-600 dark:text-slate-400 mt-2 font-mono">Gemini Neural Core // v1.5 Pro</p>
        </div>
      ...
      {!analysis && !loading && (
        <div className="glass-panel rounded-3xl p-12 md:p-32 text-center border border-slate-300 dark:border-white/10 relative overflow-hidden md:perspective-[1000px]">
          ...
          <div className="relative z-10 flex flex-col items-center card-3d">
            ...
            <h3 className="text-2xl font-bold text-slate-900 dark:text-white tracking-wide font-[Space_Grotesk]">AWAITING DATA INPUT</h3>
            <p className="text-slate-600 dark:text-slate-400 max-w-md mx-auto mt-4 leading-relaxed">
      ...
      {loading && (
        <div className="glass-panel rounded-3xl p-32 text-center relative overflow-hidden">
          ...
          <h3 className="text-2xl font-bold text-slate-900 dark:text-white animate-pulse font-mono tracking-widest">ANALYZING</h3>
          ...
          <div className="md:col-span-2 relative overflow-hidden rounded-3xl p-10 border border-indigo-500/30 bg-slate-900/60 backdrop-blur-xl card-3d group">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white font-[Space_Grotesk]">Executive AI Analysis</h3>
              </div>
          ...
          <div className="glass-panel p-8 rounded-3xl border-t-4 border-t-rose-500 hover:bg-rose-950/10 transition-colors card-3d">
             ...
             <ul className="space-y-4">
               ...
               {analysis.warnings.length === 0 && (
                 <li className="text-slate-600 dark:text-slate-500 italic flex items-center gap-2">
